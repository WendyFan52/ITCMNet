...
def parse_args():
    ...
    parser.add_argument(
        '--inputs', default='data/coco/test2017',type=str, help='Input image file or folder path.')
    parser.add_argument(
        '--model',default='work_dirs\mask-rcnn_convnext-v2-b_fpn_lsj-3x-fcmae_coco\mask-rcnn_convnext-v2-b_fpn_lsj-3x-fcmae_coco.py',
        type=str,
        help='Config or checkpoint .pth file or the model name '
        'and alias defined in metafile. The model configuration '
        'file will try to read from .pth if the parameter is '
        'a .pth weights file.')
    parser.add_argument('--weights', default='./work_dirs/mask-rcnn_convnext-v2-b_fpn_lsj-3x-fcmae_coco/best_coco_vital_precision_epoch_1.pth', help='Checkpoint file')
    parser.add_argument(
        '--out-dir',
        type=str,
        default='outputs',
