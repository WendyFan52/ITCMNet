...
launcher = 'none'
load_from = '.\\work_dirs\\mask-rcnn_convnext-v2-b_fpn_lsj-3x-fcmae_coco\\best_coco_Pinus_precision_epoch_8.pth'
log_level = 'INFO'
log_processor = dict(
...
model = dict(
    ...
    test_cfg=dict(
        rcnn=dict(
            mask_thr_binary=0.5,
            max_per_img=100,
            nms=dict(iou_threshold=0.4, type='soft_nms'),
            score_thr=0.05),
        rpn=dict(
            max_per_img=1000,
            min_bbox_size=0,
...
test_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='data/coco/annotations/instances_tree_eval2023.json',
        backend_args=None,
...
train_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='data/coco//annotations/instances_tree_train2023.json',
        backend_args=None,
        data_prefix=dict(img='data/coco//train2017/'),
        data_root='',
...
work_dir = './work_dirs\\mask-rcnn_convnext-v2-b_fpn_lsj-3x-fcmae_coco'
